...
class ComposerStaticInitf629a3fd55952c429bc76fa5f29bbf39
{
    public static $files = array (
        ...
        '5a81ec39bbef1c052f1c56223787746d' => __DIR__ . '/../..' . '/includes/Helpers/Core.php',
        'ca825068501ecca76318d7ffa746d84a' => __DIR__ . '/../..' . '/includes/Helpers/Conditional.php',
        '26177fb61224cf016ee1ad7eccc0737d' => __DIR__ . '/../..' . '/includes/Helpers/Format.php',
        '1c1e38b7599763c61d31b32250b00953' => __DIR__ . '/../..' . '/includes/Helpers/UrlSchemeHelpers.php',
    );
    ...
    public static $classMap = array (
        ...
        'HRT\\Activation' => __DIR__ . '/../..' . '/includes/Activation.php',
        'HRT\\AdminMenu' => __DIR__ . '/../..' . '/includes/AdminMenu.php',
        'HRT\\Constants' => __DIR__ . '/../..' . '/includes/Constants.php',
        'HRT\\Contracts\\ModelCore' => __DIR__ . '/../..' . '/includes/Contracts/ModelCore.php',
        'HRT\\DBLogger' => __DIR__ . '/../..' . '/includes/DBLogger.php',
        'HRT\\DateTime' => __DIR__ . '/../..' . '/includes/DateTime.php',
        'HRT\\Deactivation' => __DIR__ . '/../..' . '/includes/Deactivation.php',
        'HRT\\Facades\\Route' => __DIR__ . '/../..' . '/includes/Facades/Route.php',
        'HRT\\HTTPRequestsTracker' => __DIR__ . '/../..' . '/includes/HTTPRequestsTracker.php',
        'HRT\\Install' => __DIR__ . '/../..' . '/includes/Install.php',
        'HRT\\ModelCore' => __DIR__ . '/../..' . '/includes/ModelCore.php',
        'HRT\\Models\\Setting' => __DIR__ . '/../..' . '/includes/Models/Setting.php',
        'HRT\\Permissions\\CorePermissions' => __DIR__ . '/../..' . '/includes/Permissions/CorePermissions.php',
        'HRT\\Permissions\\LogsApiPermissions' => __DIR__ . '/../..' . '/includes/Permissions/LogsApiPermissions.php',
        'HRT\\Permissions\\Permissions' => __DIR__ . '/../..' . '/includes/Permissions/Permissions.php',
        'HRT\\Permissions\\PermissionsList' => __DIR__ . '/../..' . '/includes/Permissions/PermissionsList.php',
        'HRT\\Permissions\\SettingsApiPermissions' => __DIR__ . '/../..' . '/includes/Permissions/SettingsApiPermissions.php',
        'HRT\\Permissions\\StatsApiPermissions' => __DIR__ . '/../..' . '/includes/Permissions/StatsApiPermissions.php',
        'HRT\\Providers\\AppServiceProvider' => __DIR__ . '/../..' . '/includes/Providers/AppServiceProvider.php',
        'HRT\\Providers\\SettingServiceProvider' => __DIR__ . '/../..' . '/includes/Providers/SettingServiceProvider.php',
        'HRT\\Providers\\UrlSchemesServiceProvider' => __DIR__ . '/../..' . '/includes/Providers/UrlSchemesServiceProvider.php',
        'HRT\\RestAPI\\Routes\\RoutesRegistrar' => __DIR__ . '/../..' . '/includes/RestAPI/Routes/RoutesRegistrar.php',
        'HRT\\RestAPI\\Routing\\Route' => __DIR__ . '/../..' . '/includes/RestAPI/Routing/Route.php',
        'HRT\\RestAPI\\Routing\\RouteCollection' => __DIR__ . '/../..' . '/includes/RestAPI/Routing/RouteCollection.php',
        'HRT\\RestAPI\\Routing\\Router' => __DIR__ . '/../..' . '/includes/RestAPI/Routing/Router.php',
        'HRT\\ScriptStyle' => __DIR__ . '/../..' . '/includes/ScriptStyle.php',
        'HRT\\URL' => __DIR__ . '/../..' . '/includes/URL.php',
        'HRT\\UrlSchemes\\AbsoluteUrlScheme' => __DIR__ . '/../..' . '/includes/UrlSchemes/AbsoluteUrlScheme.php',
        'HRT\\UrlSchemes\\OnlyUrlArgsUrlScheme' => __DIR__ . '/../..' . '/includes/UrlSchemes/OnlyUrlArgsUrlScheme.php',
        'HRT\\UrlSchemes\\PredefinedUrlScheme' => __DIR__ . '/../..' . '/includes/UrlSchemes/PredefinedUrlScheme.php',
        'HRT\\UrlSchemes\\RegexUrlScheme' => __DIR__ . '/../..' . '/includes/UrlSchemes/RegexUrlScheme.php',
        'HRT\\UrlSchemes\\RelativeUrlScheme' => __DIR__ . '/../..' . '/includes/UrlSchemes/RelativeUrlScheme.php',
        'HRT\\UrlSchemes\\UrlScheme' => __DIR__ . '/../..' . '/includes/UrlSchemes/UrlScheme.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitf629a3fd55952c429bc76fa5f29bbf39::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitf629a3fd55952c429bc76fa5f29bbf39::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInitf629a3fd55952c429bc76fa5f29bbf39::$classMap;
